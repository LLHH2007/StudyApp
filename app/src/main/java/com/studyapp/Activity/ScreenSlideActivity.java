...
public class ScreenSlideActivity extends FragmentActivity {
    ...
    TextView tvTimer, tvOverView, tvScore;
    CounterClass timer;
    String subject;
    //num_exam nay dung de lay so luong data
    int num_exam;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvScore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent1.putExtra("arr_Ques",questionArrayList);
    ...
    private class ScreenSlidePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            return new ScreenSlideFragment().create(position,checkAns);
        }
